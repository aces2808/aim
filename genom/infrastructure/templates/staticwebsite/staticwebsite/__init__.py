"""
Static Website Infrastructure Module

This module provides AWS CDK constructs for deploying a static website
with S3 bucket and CloudFront distribution.
"""
...
def get_project_env(project_name: str = "agriyard", environment: str = "dev") -> str:
    """
    ...
    Returns:
        Project environment string (e.g., "agriyard-dev")
    """
    cfg = config()
